...
# this dictionary is used for referencing which option they choose
# from the string displayed above.
user_selection = {
    "1.": popular_articles,
    "1": popular_articles,
    "2.": popular_authors,
...
# this is the main loop to allow the user to make a selection and
# will only close when they input "quit", which makes do_not_exit = false
